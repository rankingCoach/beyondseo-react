import {Roles} from '@models/swagger/BeyondSEO/Domain/Common/Entities/Roles/Roles';
import {Capabilities} from '@models/swagger/BeyondSEO/Domain/Common/Entities/Capabilities/Capabilities';
import {WPLegacyAccountSettings} from '@models/swagger/BeyondSEO/Domain/Integrations/WordPress/Common/Entities/Accounts/Legacy/Settings/WPLegacyAccountSettings';
import {Person} from '@models/swagger/BeyondSEO/Domain/Common/Entities/Persons/Person';
import {Account} from '@models/swagger/BeyondSEO/Domain/Common/Entities/Accounts/Account';
import {Roles} from '@models/swagger/BeyondSEODeps/DDD/Domain/Common/Entities/Roles/Roles';
import {ContactInfos} from '@models/swagger/BeyondSEO/Domain/Common/Entities/ContactInfos/ContactInfos';
  ...
  export const WPLegacyAccountObjectType = {
    BeyondSEO_Domain_Integrations_WordPress_Common_Entities_Accounts_Legacy_WPLegacyAccount : "BeyondSEO\\Domain\\Integrations\\WordPress\\Common\\Entities\\Accounts\\Legacy\\WPLegacyAccount",
  }
