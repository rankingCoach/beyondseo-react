...
import {ContactInfos} from '@models/swagger/BeyondSEO/Domain/Common/Entities/ContactInfos/ContactInfos';
  ...
  export const WPAccountObjectType = {
    BeyondSEO_Domain_Integrations_WordPress_Common_Entities_Accounts_WPAccount : "BeyondSEO\\Domain\\Integrations\\WordPress\\Common\\Entities\\Accounts\\WPAccount",
  }
...
* 
    */
  status: typeof WPAccountStatus[keyof typeof WPAccountStatus]
  owner?: Person
   /**
...
* 
    */
  type: typeof WPAccountType[keyof typeof WPAccountType]
  roles?: Roles
  ...
  id?: number
    ...
    */
  objectType: typeof WPAccountObjectType[keyof typeof WPAccountObjectType] 
}
