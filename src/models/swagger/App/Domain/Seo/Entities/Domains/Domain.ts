...
import {DomainContent} from '@models/swagger/App/Domain/Seo/Entities/Domains/DomainContent';
import {WebPages} from '@models/swagger/App/Domain/Seo/Entities/WebPages/WebPages';

  export const DomainObjectType = {
    App_Domain_Seo_Entities_Domains_Domain : "App\\Domain\\Seo\\Entities\\Domains\\Domain",
  }
